...
(function() {
  var encode_weights, filter_data, getShareLink, parse_weights, root, setupPartyList, smartSync, _ref,
  ...
  root.AppView = (function(_super) {
    ...
    AppView.prototype.calculate = function() {
      return this.candidatesView.calculate(this.agendaListView.getWeights());
    };
