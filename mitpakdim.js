...
(function() {
  var create_delegation, encode_weights, extendArrayWithId, filter_data, ga, getShareLink, multiSync, parse_weights, root, setupPartyList, smartSync, _ref, _ref1,
    __slice = [].slice,
  ...
  parse_weights = function(weights) {
    ...
    _.each(weights.split('i'), function(item) {
      var key, value, _ref2;
      _ref2 = item.split('x'), key = _ref2[0], value = _ref2[1];
  ...
  root.SelectableCollection = (function(_super) {
    ...
    SelectableCollection.prototype.initialize = function() {
      ...
      return this.on('select', function(new_model, collection, options) {
        var attr_name, info, old_model, _ref2, _ref3;
        if (collection === 'all') {
          collection = _this;
        }
        if (!collection) {
        ...
        attr_name = (_ref2 = options != null ? options.attr_name : void 0) != null ? _ref2 : default_attr_name;
        if ((_ref3 = _this.selecteds) == null) {
          _this.selecteds = {};
        }
    ...
    SelectableCollection.prototype.getSelected = function(attr_name) {
      ...
      return (_ref2 = this.selecteds) != null ? _ref2[attr_name] : void 0;
    };
  ...
  root.ListView = (function(_super) {
    ...
    ListView.prototype.initialize = function() {
      ...
      if ((_ref3 = (_base1 = this.options).autofetch) == null) {
